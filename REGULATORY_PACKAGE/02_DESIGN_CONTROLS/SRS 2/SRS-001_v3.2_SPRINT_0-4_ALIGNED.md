...
*(REQ-HD-003 a REQ-HD-015: Mantidos conforme v3.0 - não reproduzidos aqui para economizar espaço)*
...
|-------------|------|---------------|---------------|-----------------|
| **S-NEUTROPENIA-GRAVE** | Critical Neutropenia | `any: [E-ANC-VCRIT, E-ANC-CRIT]` | ✅ Yes | Sepsis risk - urgent hospitalization |
| **S-BLASTIC-SYNDROME** | Acute Leukemia | `all: [E-BLASTS-PRESENT]` | ✅ Yes | Urgent chemotherapy |
| **S-TMA** | Thrombotic Microangiopathy | `all: [E-PLT-CRIT-LOW, E-SCHISTOCYTES-GE1PCT]`<br>`any: [E-LDH-HIGH, E-BT-IND-HIGH, E-CREATININA-HIGH]` | ✅ Yes | Plasmapheresis urgency |
| **S-PLT-CRITICA** | Critical Thrombocytopenia | `any: [E-PLT-CRIT-LOW]` | ✅ Yes | Hemorrhagic risk - transfusion |
| **S-ANEMIA-GRAVE** | Severe Anemia | `all: [E-HB-VERY-LOW]` | ✅ Yes | Transfusion urgency |
| **S-NEUTROFILIA-LEFTSHIFT-CRIT** | Critical Leukemoid Reaction | `all: [E-WBC-VERY-HIGH, E-LEFTSHIFT]` | ✅ Yes | Leukostasis risk |
| **S-THROMBOCITOSE-CRIT** | Critical Thrombocytosis | `all: [E-THROMBOCYTOSE-CRIT]` | ✅ Yes | Thrombotic risk |
| **S-CIVD** | Disseminated Intravascular Coagulation | `threshold: 0.67`<br>`any: [E-PLT-LOW, E-D-DIMER-HIGH, E-PT-PROLONGED, E-APTT-PROLONGED, E-FIBRINOGEN-LOW]` | ✅ Yes | DIC - critical |
| **S-PANCYTOPENIA** | Pancytopenia | `all: [E-ANEMIA, E-NEUTROPENIA, E-THROMBOCYTOPENIA]` | ✅ Yes | Bone marrow failure |
...
REQ-HD-017 (35 Syndromes)
  → 03_syndromes_hybrid.yaml v2.3.1 (YAML source)
  → SDD-001 §3.5 (Syndrome Fusion Engine design)
  → TEST-HD-084 (100+ syndrome tests)
  → RISK-HD-022 (Combine logic error risk)
  → IFU-001 §5.3 (Syndrome catalog documentation)
  → PMS-001 §5.3 (Syndrome detection monitoring)
```
...
| **v3.1 (YAMLS RECONSTRUCTION)** | **2025-10-20** | **Abel Costa + Claude Code** | **MAJOR UPDATE: Reconstructed from YAMLs v2.4.0 as source of truth. Added 10 new functional requirements (REQ-HD-016 to REQ-HD-025) documenting YAML modules. Expanded Data Dictionary (14→54 fields). Added Clinical Evidence Catalog (79 evidences) and Syndrome Catalog (35 syndromes). Documented operational systems: WORM log, routing, missingness, next steps, normalization. Total: 25 functional requirements, ~2,500 lines. Ready for Sprint 0 implementation (20-26 Oct).** |
